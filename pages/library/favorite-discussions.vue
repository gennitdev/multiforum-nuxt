...
import { GET_USER_FAVORITE_DISCUSSIONS } from '@/graphQLData/user/queries';
...
const getDiscussionLink = (discussion: any) => {
  const firstChannel = safeArrayFirst(discussion.DiscussionChannels);
