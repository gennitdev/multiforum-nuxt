    ...
    filterGroups: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "discover_university", displayName: "Discover University", order: 7 },
          ...
          { value: "high_school_years", displayName: "High School Years", order: 11 },
          ...
          { value: "businesses_hobbies", displayName: "Businesses & Hobbies", order: 17 },
          { value: "enchanted_by_nature", displayName: "Enchanted by Nature", order: 18 },
        ]
      },
      {
        key: "game_packs",
        ...
        options: [
          ...
          { value: "journey_to_batuu", displayName: "Journey to Batuu", order: 8 },
          { value: "dream_home_decorator", displayName: "Dream Home Decorator", order: 9 },
          { value: "my_wedding_stories", displayName: "My Wedding Stories", order: 10 },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "vintage_glamour", displayName: "Vintage Glamour Stuff", order: 4 },
          ...
          { value: "crystal_creations", displayName: "Crystal Creations", order: 15 },
        ]
      },
      {
        key: "advanced",
