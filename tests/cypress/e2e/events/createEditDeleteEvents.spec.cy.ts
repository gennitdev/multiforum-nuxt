...
describe('Basic event operations', () => {
  ...
  it('creates, edits and deletes an online event with virtual event type', () => {
    ...
    cy.get('input[data-testid="start-time-date-input"]').type(
      formatDate(startDateTime)
    );
    cy.get('input[data-testid="start-time-time-input"]').type(
    ...
    cy.get('input[data-testid="end-time-date-input"]').type(
      formatDate(endDateTime)
    );
    cy.get('input[data-testid="end-time-time-input"]').type(
    ...
    // Change the end date
    cy.get('input[data-testid="end-time-date-input"]')
      .clear()
      .type(formatDate(editedEndDateTime));

    // Change the end time
    cy.get('input[data-testid="end-time-time-input"]')
      .clear()
      .type(formatTime(editedEndDateTime));
