            ...
            <div>
              ...
              <div class="flex space-x-2">
                <button
                  ...
                  class="flex items-center px-3 py-1.5 text-xs bg-blue-500 hover:bg-blue-600 text-white rounded-md transition-colors"
                >
                ...
                <button
                  ...
                  class="flex items-center px-3 py-1.5 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors"
                >
                  <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  class="flex items-center px-3 py-1.5 text-xs bg-blue-700 hover:bg-blue-800 text-white rounded-md transition-colors"
                >
                  <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  @click="copyLink"
                  class="flex items-center px-3 py-1.5 text-xs bg-gray-500 hover:bg-gray-600 text-white rounded-md transition-colors"
                >
            ...
            <div>
              ...
              <div class="flex items-center space-x-2">
                ...
                <button
                  ...
                  class="flex items-center px-3 py-2 text-xs bg-orange-500 hover:bg-orange-600 text-white rounded-md transition-colors flex-shrink-0"
                >
                  <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
                  </svg>
